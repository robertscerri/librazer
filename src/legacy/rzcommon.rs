...
impl From<[u8; RZ_REPORT_LEN]> for RzReport {
    fn from(buf: [u8; RZ_REPORT_LEN]) -> Self {
        let num_params = buf[5].saturating_sub(1) as usize;
        ...
        RzReport {
            ...
            cmd: buf[7],
            sub_cmd: buf[8],
            params: buf[9..(9 + num_params)].to_vec(),
        }
    }
}
...
impl RzDevice {
    ...
    fn get_device_type(&self) -> RzDeviceType {
        match self.pid {
            ...
            | RZ_PID_VIPER_V3_HYPERSPEED => return RzDeviceType::Mouse,
            ...
            | RZ_PID_BLACKWIDOW_V3_TK => return RzDeviceType::Keyboard,
            RZ_PID_KRAKEN_CLASSIC
            | RZ_PID_KRAKEN
            | RZ_PID_KRAKEN_CLASSIC_ALT
            | RZ_PID_KRAKEN_V2
            | RZ_PID_KRAKEN_ULTIMATE => return RzDeviceType::Kraken,
            ...
            | RZ_PID_LAPTOP_STAND_CHROMA_V2 => return RzDeviceType::Accessory,
            _ => {
